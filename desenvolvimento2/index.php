...
<html lang="pt-BR">
  <head>
    ...
    <title>Site com Faixa no Topo</title>
    ...
    <style>
      * {
      ...
      .faixa-topo {
        ...
        width: 100%;
        height: 230px;
        background-image: url('https://www3.maringa.pr.gov.br/construtor/imagens/120623091046_juventude_jpg.jpg');
        background-size: cover;
        background-position: center;
        z-index: 10;
        border-bottom: 3px solid #0d2a5b;
      }
      ...
      .caixa {
        ...
        align-items: center;
        margin-top: 140px; /* espaço da faixa */
      }
