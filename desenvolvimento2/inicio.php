        ...
        <div class="row justify-content-center row-cols-1 row-cols-md-4 mb-4 text-center">
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sw">
                    ...
                    <div class="card-body text-center" style="background-color: whte;">
                        <center>
                        <?php
                            $sql = "SELECT count(id) AS numusu FROM usuarios_novos";
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sw">
                    ...
                    <div class="card-body text-start" style="background-color: white;">
                        <center>
                        <?php
  ...
  <path d="M7 5.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5m-1.496-.854a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0M7 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5m-1.496-.854a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 0 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0"/>
        ...
        <div class="row justify-content-center row-cols-3 row-cols-md-4 mb-4 text-center">
            ...
            <div class="col">
                ...
                <div class="col">
                <div class="card mb-1 rounded-1 shadow-sw">
                    <div class="card-header py-2">
                        <h2>GÊNERO DO USUÁRIOS</h2>
                    </div>
                    <div class="card-body text-start">
                        <?php
                            include 'graf_usuarios.php';
                        ?>
