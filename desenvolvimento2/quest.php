...
<center>
    <h2>
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="black" class="bi bi-card-list" viewBox="0 0 16 16">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">TEATROS</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        $pesquisa = mysqli_query($conn, "SELECT * FROM quest ORDER BY esportes");
                        if (!$pesquisa) {
                            ...
                            if (mysqli_num_rows($pesquisa) > 0) {
                                while ($registro = mysqli_fetch_assoc($pesquisa)) {
                                    ...
                                    echo "<td>" . htmlspecialchars($registro['teatros']) . "</td>";
                                    echo "</tr>";
                                }
                            } else {
        ...
        <div class="modal-content">
            <form action="quest_cadastro.php" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="teatros" class="form-label">TEATROS</label>
