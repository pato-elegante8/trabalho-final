...
<body>
    ...
    <img src="Captura de tela 2024-10-13 084403.png" alt="">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card mb-4 rounded-3 shadow-sm">
                    <div class="card-header text-center py-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#105c93" class="bi bi-person-circle" viewBox="0 0 16 16">
                    ...
                    <div class="card-body">
                        <form action="formulario.php" method="POST">
                         ...
                         <div class="mb-3">
                        <label for="cursos" class="form-label">GENERO</label>
                        <select class="form-select" id="cursos" name="cursos" required>
                            <option value="" selected disabled>Faça a sua escolha</option>
                            <option value="Bacharelados">MASCULINO</option>
                            <option value="Licenciaturas">FEMININO</option>
                            <option value="Tecnólogos">OUTRO</option>
                        </select>
                    </div>
