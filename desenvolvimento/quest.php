                                    ...
                                    <?php
                                        ...
                                        if ($row > 0) {
                                            while ($registro = $pesquisa -> fetch_array()) {
                                                ...
                                                echo '<td>'.$teatro.'</td>';
                                                echo '<td><a href=><svg xmlns= width="22" height="22" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                        ...
                        <form action="quest_cadastro.php" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="esporte" required>
                                    <br>
                                    <label>MUSICAS</label>
                                <input type="text" class="form-control" name="musicas" required>
                                <br>
                                    <label>CURSOS</label>
